...
- ⚠️ **Wichtig:** Deine Eingaben werden zur Verarbeitung an die (kostenpflichtige) KI von OpenAI (GPT-Modell) gesendet. [OpenAI](https://platform.openai.com/docs/guides/your-data) erklärt: "Your data is your data. As of March 1, 2023, data sent to the OpenAI API is not used to train or improve OpenAI models (unless you explicitly opt in to share data with us)."
- **Alternative:** Ein persönlichen ChatGPT, Mistral, DeepSeek, ... Account. Dieser hat aber gegenüber dieser App den Nachteil, dass OpenAI dort Deine Daten direkt Deiner Person zuordnen kann. Hier hingegen nur dieser App.
